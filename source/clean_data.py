...
# class Dat:
    ...
    # def _direction_lookup(self,destination_x, origin_x, destination_y, origin_y) -> List:
    ...
    # def cut_heading(self,data: DataFrame, dir: str, tolerance: int = 5) -> None:
    #     if "Heading" not in data.columns:
    #         self._get_heading(data)

    #     # mean_heading = mean(data.Heading.values)
    ...
    #                     or data.Heading[i] > 270-tolerance and data.Heading[i] < 270+tolerance\
