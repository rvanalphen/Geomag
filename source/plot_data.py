...
def _cartopy_main(app: MagApp,transform, length=100, segments=5,unit='m'):
...
def cartoplot(app: MagApp,data_name: str,plot_lines=True,length=100, segments=5,unit='m'):
    
    transform = ccrs.PlateCarree()
    color = ['blue']

    carto_fig,carto_ax = _cartopy_main(app,transform,length,segments,unit)
